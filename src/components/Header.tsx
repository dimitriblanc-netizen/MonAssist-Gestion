    ...
    <header className="bg-white border-b border-slate-200/80 sticky top-0 z-40 shadow-xs">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          {/* Logo & Dryos Tag */}
          <div 
            className={`flex items-center space-x-3.5 ${onNavigateToLanding ? 'cursor-pointer group' : ''}`}
            onClick={onNavigateToLanding}
            title={onNavigateToLanding ? "Retour à l'accueil" : undefined}
          >
                    ...
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-40 animate-in fade-in zoom-in-95 duration-100">
                      <div className="px-4 py-2 border-b border-slate-100">
                        <p className="text-xs font-bold text-slate-800 truncate">
                          {currentUser.displayName || 'Bailleur connecté'}
                        </p>
